...
const PARITY_ROWS: ReadonlyArray<{
  ...
  { key: "run", bad: ["--run", ""], addContext: ["--font", "Archivo"], editContext: [], editId: "textId", names: "--run takes the run's text" },
  { key: "run-text", bad: ["--run-text", "banana"], addContext: ["--text", "hi", "--font", "Archivo"], editContext: [], editId: "textId", names: "--run-text must be" },
  { key: "runs", bad: ["--runs", "banana"], addContext: ["--text", "hi", "--font", "Archivo"], editContext: [], editId: "textId", names: "--runs takes" },
  { key: "run-color", bad: ["--run-color", "banana"], addContext: ["--text", "hi", "--font", "Archivo"], editContext: [], editId: "textId", names: "--run-color must be" },
  { key: "run-font", bad: ["--run-font", "banana"], addContext: ["--text", "hi", "--font", "Archivo"], editContext: [], editId: "textId", names: "--run-font must be" },
  { key: "run-font-file", bad: ["--run-font-file", "2="], addContext: ["--text", "hi", "--font", "Archivo"], editContext: [], editId: "textId", names: "--run-font-file takes a path" },
  { key: "run-weight", bad: ["--run-weight", "2=banana"], addContext: ["--text", "hi", "--font", "Archivo"], editContext: [], editId: "textId", names: "Weight (--run-weight)" },
  { key: "run-width", bad: ["--run-width", "2=banana"], addContext: ["--text", "hi", "--font", "Archivo"], editContext: [], editId: "textId", names: "Width (--run-width)" },
  ...
  { key: "unit", bad: ["--unit", "bad name!"], addContext: [], editContext: [], editId: "imageId", names: "--unit takes" },
];
