...
test("layer edit: the generation/output block precedes the numeric parses", async () => {
  ...
  await expectRefusal(
    ...
    2,
    "No edit options provided: specify at least one of --image, --from-generation, --from-matte, --text, --shape, --size, --corner-radius, --fill, --font, --font-file, --font-size, --color, --weight, --width, --tracking, --line-height, --x, --y, --opacity, --anchor, --resize, --resize-to, --scale, --rotate, --flip, --shadow, --outline, --visible-region, --visible-region-radius, or --fork.",
  );
