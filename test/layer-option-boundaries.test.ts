...
test("layer edit: the generation/output block precedes the numeric parses", async () => {
  ...
  await expectRefusal(
    ...
    2,
    "No edit options provided: specify at least one of --image, --from-generation, --from-matte, --text, --shape, --size, --corner-radius, --fill, --vector-color, --font, --font-file, --font-size, --color, --weight, --width, --tracking, --line-height, --wrap-width, --fit-box, --run, --run-text, --runs, --run-color, --run-font, --run-font-file, --run-weight, --run-width, --x, --y, --opacity, --anchor, --resize, --resize-to, --cover-to, --scale, --scale-to, --rotate, --flip, --skew, --perspective, --shadow, --outline, --inner-shadow, --visible-region, --visible-region-radius, --brightness, --contrast, --saturation, --warmth, --blend, --glow, --blur, --choke, --feather, or --fork.",
  );
